...
export async function POST() {
  try {
    ...
    const clients = ["Rajesh Fabrics", "Meera Textiles", "Gupta Garments", "Singh Brothers", "Patel Silks", "Kumar Exports", "Sharma Traders", "Agarwal Fashion", "Jain Impex", "Verma & Sons"];
    const workers = ["Ramesh Kumar", "Suresh Yadav", "Ajay Singh", "Vijay Sharma", "Mohan Lal", "Ravi Verma", "Deepak Joshi"];
